...
_Generated by `scripts/render_profile.py` from `artifacts/profile/profile-20260920T185522Z.json` (code commit `5aa9fde4e7e6`); full hashes are in the artifact._
