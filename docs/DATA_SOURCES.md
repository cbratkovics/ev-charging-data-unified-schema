...
_Generated by `scripts/render_profile.py` from `artifacts/profile/profile-20260920T193903Z.json` (code commit `685fe7afbef7`); full hashes are in the artifact._
