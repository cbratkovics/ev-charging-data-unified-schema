...
_Generated by `scripts/render_profile.py` from `artifacts/profile/profile-20260919T235137Z.json` (code commit `b6841cdc9256`); full hashes are in the artifact._
