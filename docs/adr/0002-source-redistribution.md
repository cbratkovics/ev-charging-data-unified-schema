...
1. *Cary and Boulder (CC0):* the raw CSV files may be committed. They are still **not**
   committed in this repository: Boulder's file is 23,276,419 bytes and Cary's 2,500,986 <!-- cite: artifacts/profile/profile-20260919T235137Z.json#sources.boulder.files[0].bytes; artifacts/profile/profile-20260919T235137Z.json#sources.cary.files[0].bytes -->, the landed parquet is
...
3. *Station registry (matching not built; moved to docs/ROADMAP.md by ADR-0012):* the terms permit any use. Registry pulls are committed as aggregates
